...
func Request(method, route string, body *url.Values, handler http.HandlerFunc) httptest.ResponseRecorder {
...
func ParameterizedRequest(method, prepared_route string, route string, qs *url.Values, body *url.Values, handler http.HandlerFunc) httptest.ResponseRecorder {
	return Req(handler, method, prepared_route, route, qs, body)
}

func ParameterizedJsonRequest(method, prepared_route string, route string, qs *url.Values, iface interface{}, handler http.HandlerFunc) httptest.ResponseRecorder {
...
func JsonRequest(method, route string, qs *url.Values, iface interface{}, handler http.HandlerFunc) httptest.ResponseRecorder {
	headers := map[string]interface{}{
		"Content-Type": "application/json",
	}
...
func Req(handler http.HandlerFunc, method, prepared_route, route string, args ...interface{}) httptest.ResponseRecorder {
	...
	r.HandleFunc(prepared_route, handler).Methods(method)
